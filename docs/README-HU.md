<p align="center">
  ...
  <b>Kell a segítséged, hogy lefordítsuk ezt a README-t, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">a cpaydesk UI-t</a> és a <a href="https://github.com/rustdesk/doc.cpaydesk.51cpay.com">Dokumentációt</a> az anyanyelvedre</b>
</p>
...
[![cpaydesk Server Pro](https://img.shields.io/badge/cpaydesk%20Server%20Pro-Speci%C3%A1lis%20Funkci%C3%B3k-blue)](https://cpaydesk.51cpay.com/pricing.html)

A cpaydesk egy távoli elérésű asztali szoftver, Rust-ban írva. Működik mindenféle konfiguráció nélkül, feltelepítéssel, vagy anélkül. Az adataidat teljesen te kezeled, nincs szükség aggódásra a harmadik felek miatt. Használhatod a cpaydesk punblikus randevú/relay szervereit, [hostolhatsz sajátot](https://cpaydesk.51cpay.com/server), vagy akár [írhatsz is egyet](https://github.com/rustdesk/rustdesk-server-demo).

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png)

A cpaydesk szívesen fogad minden contributiont, támogatást mindenkitől. Lásd a [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) fájlt a kezdéshez.

[**Hogyan működik a cpaydesk?**](https://github.com/rustdesk/rustdesk/wiki/How-does-cpaydesk-work%3F)
...
## [Építés](https://cpaydesk.51cpay.com/docs/hu/dev/build/)
...
Ezután, minden egyes alkalommal amikor meg kell építened a cpaydesk-et, futtasd a kövezkező parancsot:
...
Kérlek mindenképpen nézd meg hogy ezeket a parancsokat a root cpaydesk mappában futtatod e, különben a cpaydesk lehet hogy nem fogja megtalálni az építéshez szükséges elemeket. Fontos az is, hogy jelenleg más cargo subparancsok, például `install`vagy `run` nem támogatottak, mivel egy Dockeres építés esetén elindítanák a programot a containeren belül.
