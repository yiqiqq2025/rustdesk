<p align="center">
  <img src="../res/logo-header.svg" alt="cpaydesk - Uw bureaublad op afstand"><br>
  ...
  <b>Wij hebben uw hulp nodig om dit README bestand te vertalen, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">cpaydesk UI</a> en <a href="https://github.com/rustdesk/doc.cpaydesk.51cpay.com">Doc</a> naar uw moedertaal</b>
</p>
...
[![cpaydesk Server Pro](https://img.shields.io/badge/cpaydesk%20Server%20Pro-Geavanceerde%20Functies-blue)](https://cpaydesk.51cpay.com/pricing.html)

Alweer een andere programma voor -bureaublad op afstand-, geschreven in Rust. Werkt -out of the box-, geen configuratie nodig. U heeft volledige controle over uw gegevens, en hoeft zich geen zorgen te maken over de beveiliging. U kunt onze rendez-vous/relay server gebruiken, [je eigen server opzetten](https://cpaydesk.51cpay.com/blog/id-relay-set), of [je eigen rendez-vous/relay-server schrijven](https://github.com/rustdesk/rustdesk-server-demo).

cpaydesk verwelkomt bijdragen van iedereen. Zie [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) voor hulp om aan de slag te gaan.
...
## [Bouwen](https://cpaydesk.51cpay.com/docs/en/dev/build/)
...
Zorg ervoor dat je deze commando's van de root van de cpaydesk-repository uitvoert, anders kan het programma de nodige afhankelijkheden mogelijk niet vinden. Let ook op dat andere cargo-subcommando's zoals `install` en `run` zijn momenteel niet ondersteund, aangezien deze zouden worden uitgevoerd in een container in plaats van op de host.
