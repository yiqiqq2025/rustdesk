<p align="center">
  <img src="../res/logo-header.svg" alt="cpaydesk – vaše vzdálená plocha"><br>
  ...
  <b>Potřebujeme Vaši pomoc s překladem tohoto README, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">uživatelského rozhraní aplikace cpaydesk</a> a <a href="https://github.com/rustdesk/doc.cpaydesk.51cpay.com">dokumentace k ní</a> do vašeho jazyka</b>
</p>
...
[![cpaydesk Server Pro](https://img.shields.io/badge/cpaydesk%20Server%20Pro-Pokro%C4%8Dil%C3%A9%20Funkce-blue)](https://cpaydesk.51cpay.com/pricing.html)

Zase další software pro přístup k ploše na dálku, naprogramovaný v jazyce Rust. Funguje hned tak, jak je – není třeba žádného nastavování. Svá data máte ve svých rukách, bez obav o zabezpečení. Je možné používat námi poskytovaný propojovací/předávací (relay) server, [vytvořit si svůj vlastní](https://cpaydesk.51cpay.com/server), nebo [si dokonce svůj vlastní naprogramovat](https://github.com/rustdesk/rustdesk-server-demo), budete-li chtít.

Projekt cpaydesk vítá přiložení ruky k dílu od každého. Jak začít se dozvíte z [`docs/CONTRIBUTING.md`](CONTRIBUTING.md).

[**Jak cpaydesk funguje?**](https://github.com/rustdesk/rustdesk/wiki/How-does-cpaydesk-work%3F)
...
## [Sestavení ze zdrojových kódů](https://cpaydesk.51cpay.com/docs/en/dev/build/)
