<p align="center">
  ...
  <b>Vi har brug for din hjælp til at oversætte denne README, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">cpaydesk UI</a> og <a href=" https://github.com/rustdesk/doc.cpaydesk.51cpay.com">Dokument</a> til dit modersmål</b>
</p>
...
[![cpaydesk Server Pro](https://img.shields.io/badge/cpaydesk%20Server%20Pro-Avancerede%20Funktioner-blue)](https://cpaydesk.51cpay.com/pricing.html)

Endnu en fjernskrivebordssoftware, skrevet i Rust. Fungerer ud af æsken, ingen konfiguration påkrævet. Du har fuld kontrol over dine data uden bekymringer om sikkerhed. Du kan bruge vores rendezvous/relay-server, [opsætte din egen](https://cpaydesk.51cpay.com/server), eller [skrive din egen rendezvous/relay-server](https://github.com/rustdesk/rustdesk- server-demo).

cpaydesk hilser bidrag fra alle velkommen. Se [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) for at få hjælp til at komme i gang.
...
## [Byg](https://cpaydesk.51cpay.com/docs/en/dev/build/)
