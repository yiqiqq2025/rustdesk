...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het cpaydesk netwerk..."),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw bureaublad op afstand te bedienen. Installeer cpaydesk op het systeem om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u cpaydesk toestemming voor Toegankelijkheid geven."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u cpaydesk toestemming voor Schermopname geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u cpaydesk toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [cpaydesk Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep cpaydesk background service", "cpaydesk achtergronddienst behouden"),
        ...
        ("config_input", "Om een extern apparaat met uw toetsenbord te kunnen bedienen, moet u cpaydesk toestemming voor Invoer Vastleggen geven."),
        ("config_microphone", "Om te kunnen chatten moet u cpaydesk toestemming voor Microfoon geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende cpaydesk."),
        ...
        ("verify_rustdesk_password_tip", "Bevestiging wachtwoord cpaydesk"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om cpaydesk te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Upgrade cpaydesk Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor cpaydesk mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het cpaydesk-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt cpaydesk op de achtergrond actief te houden"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Upgrade de cpaydesk client naar versie {} of nieuwer op de externe computer!"),
