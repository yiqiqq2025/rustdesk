...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Падключэнне да сеткі cpaydesk..."),
        ...
        ("install_tip", "У некаторых выпадках cpaydesk можа працаваць няправільна на аддаленым вузле з-за UAC. Каб пазбегнуць магчымых праблем з UAC, націсніце кнопку ніжэй для ўстаноўкі cpaydesk у сістэме."),
        ("Click to upgrade", "Абнавіць"),
        ("Configure", "Наладзіць"),
        ("config_acc", "Каб аддаленна кіраваць сваім працоўным сталом, вам неабходна дазволіць cpaydesk правы доступу."),
        ("config_screen", "Для аддаленага доступу да працоўнага сталу вам неабходна дазволіць cpaydesk правы здымку экрана."),
        ...
        ("android_input_permission_tip1", "Каб аддалёная прылада магла кіраваць вашай Android-прыладай з дапамогай мышы або націсканняў, неабходна дазволіць cpaydesk выкарыстоўваць паслугу \"Асаблівыя магчымасці\"."),
        ("android_input_permission_tip2", "Зайдзіце на адпаведную старонку сістэмных налад, знайдзіце і ўступіце ў \"Устаноўленыя паслугі\", уключыце паслугу \"cpaydesk Input\"."),
        ...
        ("Language", "Мова"),
        ("Keep cpaydesk background service", "Захаваць фонавую службу cpaydesk"),
        ...
        ("Show cpaydesk", "Паказаць cpaydesk"),
        ...
        ("config_input", "Каб кіраваць аддаленым працоўным сталом праз клавіятуру, неабходна дазволіць cpaydesk маніторынг уводу."),
        ("config_microphone", "Каб размаўляць з аддаленай старонкай, неабходна дазволіць cpaydesk запіс аўдыё."),
        ...
        ("still_click_uac_tip", "Дагэтуль патрэбна, каб аддалены карыстальнік націснуў \"OK\" ў акне UAC пры запуску cpaydesk."),
        ...
        ("verify_rustdesk_password_tip", "Пацвердзіць пароль cpaydesk"),
        ...
        ("scam_text1", "Калі вы размаўляеце па тэлефоне з кімсці, каго вы НЕ ВЕДАЕЦЕ і каму НЕ ДАВЕРАЕЦЕ, і ён просіць вас выкарыстаць cpaydesk і запусціць яго службу, не працягвайце і неадкладна адмяніце размову."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Абнавіце cpaydesk Server Pro да версіі {} або новейшай!"),
        ...
        ("selinux_tip", "На вашай прыладзе ўключаны SELinux, што можа перашкаджаць правільнай працы cpaydesk на кіруючым баку."),
        ...
        ("powered_by_me", "На аснове cpaydesk"),
        ...
        ("allow-only-conn-window-open-tip", "Дазволіць толькі падключэнне пры адкрытым акне cpaydesk"),
        ...
        ("floating_window_tip", "Дапамагае падтрымліваць фонавую службу cpaydesk"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Калі ласка, абнавіце кліент cpaydesk да версіі {} або навейшай на аддаленым баку!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
