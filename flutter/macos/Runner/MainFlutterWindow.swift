...
class MainFlutterWindow: NSWindow {
    override func awakeFromNib() {
        ...
        let registrar = flutterViewController.registrar(forPlugin: "cpaydeskPlugin")
        ...
        FlutterMultiWindowPlugin.setOnWindowCreatedCallback { controller in
            ...
            self.setMethodHandler(registrar: controller.registrar(forPlugin: "cpaydeskPlugin"))
    ...
    public func setMethodHandler(registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "org.cpaydesk.cpaydesk/host", binaryMessenger: registrar.messenger)
